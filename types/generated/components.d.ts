...
export interface ElementsPlan extends Schema.Component {
  ...
  attributes: {
    ...
    product_features: Attribute.Relation<"elements.plan", "oneToMany", "api::product-feature.product-feature">;
  };
}
...
export interface LayoutFooter extends Schema.Component {
  ...
  attributes: {
    ...
    categories: Attribute.Relation<"layout.footer", "oneToMany", "api::category.category">;
  };
}
...
export interface LayoutLogo extends Schema.Component {
  ...
  attributes: {
    logoImg: Attribute.Media<"images" | "files" | "videos" | "audios"> & Attribute.Required;
