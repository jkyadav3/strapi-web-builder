...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    blocks: Attribute.DynamicZone<
      ["shared.media", "shared.quote", "shared.rich-text", "shared.slider", "shared.video-embed"]
    >;
    authorsBio: Attribute.Relation<"api::article.article", "manyToOne", "api::author.author">;
...
export interface ApiLeadFormSubmissionLeadFormSubmission extends Schema.CollectionType {
  ...
  attributes: {
    ...
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::lead-form-submission.lead-form-submission", "oneToOne", "admin::user"> &
      Attribute.Private;
    updatedBy: Attribute.Relation<"api::lead-form-submission.lead-form-submission", "oneToOne", "admin::user"> &
      Attribute.Private;
  };
}
...
export interface ApiProductFeatureProductFeature extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::product-feature.product-feature", "oneToOne", "admin::user"> &
      Attribute.Private;
    updatedBy: Attribute.Relation<"api::product-feature.product-feature", "oneToOne", "admin::user"> &
      Attribute.Private;
  };
}
